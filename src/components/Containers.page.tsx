                ...
                <>
                  {composeProject !== '_' && (
                    <tr>
                      ...
                      <td>
                        {running === 0 && (
                          <Button size={'sm'} onClick={handleProjectStartClick(composeProject)}>
                            <FaPlay />{' '}
                          </Button>
                        )}
                        {running > 0 && (
                          <Button size={'sm'} onClick={handleProjectStopClick(composeProject)}>
                            <FaStop />{' '}
                          </Button>
                        )}
                        <Button size={'sm'} onClick={handleProjectRemoveClick(composeProject)} variant={'danger'}>
                          <FaTrash />{' '}
                        </Button>
                      </td>
                    </tr>
                      ...
                      <tr key={row.Id}>
                        ...
                        <td>
                          {row?.State?.Status !== 'running' && (
                            <Button size={'sm'} onClick={handleContainerStartClick(row.Id)}>
                              <FaPlay />{' '}
                            </Button>
                          )}
                          {row?.State?.Status === 'running' && (
                            <Button size={'sm'} onClick={handleContainerStopClick(row.Id)}>
                              <FaStop />{' '}
                            </Button>
                          )}
                          <Button size={'sm'} onClick={handleContainerRemoveClick(row.Id)} variant={'danger'}>
                            <FaTrash />{' '}
                          </Button>
                        </td>
                      </tr>
