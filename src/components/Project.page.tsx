...
const ProjectPage = () => {
  ...
  React.useEffect(()=> {
    ...
    let timer = setInterval(() => {
      ...
      api.getProject()(data.key).then((data) => {
  ...
  return (
    <Container>
      ...
      {/*<ProjectCreateModal />*/}
      <Button size={'sm'} onClick={handleProjectStartClick(data.key)}><FaPlay />{' '}Start</Button>
      <Button size={'sm'} onClick={handleProjectStopClick(data.key)}><FaStop />{' '}Stop</Button>
