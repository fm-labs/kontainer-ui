...
import ContainerRegistriesManagerWidget from '~/components/admin/components/ContainerRegistriesManagerWidget.tsx'
import PrivateKeysManagerWidget from '~/components/admin/components/PrivateKeysManagerWidget.tsx'
